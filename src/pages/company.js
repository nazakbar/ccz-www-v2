...
const CompanyPage = () => (
  <>
    ...
    <SectionLarge>
      ...
      <Body>With us, a new project starts with the proposal. We collaborate with our clients to understand their needs, shape the right team, figure out the appropriate budget, and set the project up for success. Together we create the proposal that makes sense.</Body>
    </SectionLarge>
    <InsetDividers />
    <SectionLarge>
